...
@register_model("nat_ctc_deep_supervision_recur_input")
class NATransformerModel(FairseqNATModel):
    ...
    def forward(
        ...
        for word_ins_out in output_logits_list:
            ...
            all_layer_ctc_loss += ctc_loss

        return {
            "ctc_loss": {"loss": all_layer_ctc_loss / len(output_logits_list)},
        }
...
@register_model_architecture(
    "nat_ctc_deep_supervision_recur_input", "nat_ctc_deep_supervision_recur_input"
)
