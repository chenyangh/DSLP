...
@register_model("nat_ctc_deep_supervision_recur_input_sample")
...
@register_model_architecture(
    "nat_ctc_deep_supervision_recur_input_sample", "nat_ctc_deep_supervision_recur_input_sample"
)
