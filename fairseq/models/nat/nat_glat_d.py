    ...
    def forward(
            ...
            if "context_p" in glat:
                with torch.no_grad():
                    with torch_seed(rand_seed):
                        ...
                        word_ins_out = word_ins_out_list[-1]
        ...
        for _idx, word_ins_out in enumerate(word_ins_out_list):
            ret_val[f"word_ins_{_idx}"] = {
                ...
                "nll_loss": True,
                "factor": 1.0 / self.decoder.num_layers,
            }
...
class NATransformerDecoder(FairseqNATDecoder):
    ...
    def forward(self, normalize, encoder_out, prev_output_tokens, step=0, **unused):
        ...
        all_layer_output_logits = all_features['inner_states'][1:]
        return [F.log_softmax(self.output_layer(x.transpose(0, 1)), -1)
                if normalize else self.output_layer(x.transpose(0, 1))
